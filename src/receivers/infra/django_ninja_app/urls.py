...
def bulk_delete_receivers(
    request, payload: DeleteReceiversIn, receiver_service: ReceiverService = anydi.auto
):
...
def read_receiver(
    request, receiver_id: uuid.UUID, receiver_service: ReceiverService = anydi.auto
):
    try:
...
def create_receiver(
    request, payload: CreateReceiverIn, receiver_service: ReceiverService = anydi.auto
):
    try:
